...
<div class="movie-heading movie-bg">
   <h3>Discover Latest Movies</h3>
</div>
...
<section class="products">
   ...
   <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `events` WHERE category='movie'") or die('query failed1111');
